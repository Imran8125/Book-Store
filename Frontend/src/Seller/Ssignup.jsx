...
const Ssignup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("/ssignup", payload)
      .then((result) => {
        setStatusMsg({ type: 'success', text: 'Seller account created successfully! Redirecting...' });
        setTimeout(() => {
          navigate('/slogin');
        }, 1500);
      })
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#130f0e]">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12 relative overflow-hidden">
        ...
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] bg-[#c5a880]/3 rounded-full blur-[80px] pointer-events-none"></div>
        ...
        <div className="glass-panel w-full max-w-md p-8 relative z-10 animate-fade-in-up border-[#342724]">
          <div className="text-center mb-8">
            ...
            <p className="text-[#a69a8b] text-sm mt-2">
              Register to sell books and manage orders
            </p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g. Haven Bookstore"
                />
              </div>
            </div>
            ...
            <button
              ...
              style={{ backgroundImage: 'linear-gradient(135deg, #aa8417 0%, #7d5e0f 100%)', color: '#f5efe4', boxShadow: '0 4px 14px 0 rgba(170, 132, 23, 0.2)' }}
            >
              <FiCheck /> Register Store
            </button>
          </form>
